    ...
    class DioEFConfigFreq
    {
        ...
        public void ConfigureFrequencyIn()
        {
            ...
            try
            {
                 ...
                 * See Datasheet reference for DIO_EF Frequency In: https://support.labjack.com/docs/13-2-5-frequency-in-t-series-datasheet
                 *
                 ...
                 * but assume that we have to use 10000 because it is set to that for PWM output on another channel:
                 *
                 * T4/T7:
