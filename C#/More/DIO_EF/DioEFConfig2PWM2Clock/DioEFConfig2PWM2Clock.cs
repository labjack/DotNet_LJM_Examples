...
namespace DioEFConfig2PWM2Clock
{
    class DioEFConfig2PWM2Clock
    {
        ...
        {
            // ------------- USER INPUT VALUES -------------
            // The pairs of DIO pins for each PWM & Frequency measurement are named like "A" and "B"
            ...
            int desiredDutyCycleA = 50;     // Set this value to your first desired PWM Duty Cycle percentage. Default 25%
            ...
            try
            {
                ...
                const int MAX_16_BIT_CLOCK_ROLL_VALUE = 65535;      // Max roll value for 16-bit DIO_EF clocks (Clock1 & Clock2) = 2^16 - 1
                 ...
                 * 
                 * DIO_EF CONFIG_A - Measurement Modes - Rising vs. Falling & One-Shot vs. Continuous:
                 ...
                 * 
                 * There are also 2 different types of measurements One-Shot & Continuous:
                 * - One-Shot
                ...
                // Set Frequency A & B Measurement Type. Default = Continuous Rising = 0b11 = 3.
                int freqAMeas = 3;
                int freqBMeas = 3;
                ...
                // Configure Intr. Frequency In A& B Registers
                ...
                Console.WriteLine($"\nMeasured Values From Signals A & B:\n");
