...
// To configure PWM to user desired frequency and duty cycle, modify the "desiredFrequency" and "desiredDutyCyclePercent" variables.
    ...
    class DioEFConfigPwm
    {
        ...
        public void ConfigurePWM()
        {
            ...
            try
            {
                ...
                Console.Out.WriteLine($"A PWM Signal at {desiredFrequency} Hz with a duty cycle of {desiredDutyCyclePercent} % is now being output on DIO{pwmDIO} for 10 seconds.");
